...
It complies with the [go-micro.Client](https://godoc.org/github.com/yadisnel/go-ms/v2client#Client) interface.
...
```go
import "github.com/yadisnel/go-ms/v2plugins/client/http"
...
```go
import _ "github.com/yadisnel/go-ms/v2plugins/client/http"
```
