...
A gRPC source server should implement the [`Source`](https://github.com/yadisnel/go-ms/v2config/blob/master/source/grpc/proto/grpc.proto#L3L6) proto interface.
